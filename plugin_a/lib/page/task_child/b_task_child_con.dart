...
import 'package:plugin_a/utils/guide/task_bubble_guide_widget.dart';
    ...
    AdUtils.instance.showAd(
        ...
        adShowListener: AdShowListener(
            onAdHidden: (ad){
              ...
              update(["list"]);
              Utils.showIncentDialog(incentFrom: IncentFrom.task,addNum: getAddNum(largeIndex, smallIndex));
            })
    );
  }
}