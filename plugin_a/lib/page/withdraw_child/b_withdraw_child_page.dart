...
import 'package:plugin_a/page/withdraw_child/b_withdraw_child_con.dart';
      ...
      children: [
        SizedBox(
          ...
          child: Row(
            children: [
              Expanded(
                child: TextWidget(text: "${Local.checkIn7Days.tr}:${WithdrawTaskUtils.instance.signDays}/7", color: color333333, size: 14.sp,fontWeight: FontWeight.w700,),
              ),
              InkWell(
                onTap: (){
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: WithdrawTaskUtils.instance.todaySigned?colorBEBEBE:colorF26910
                  ),
                  child: TextWidget(
                    text: WithdrawTaskUtils.instance.todaySigned?Local.done.tr:Local.checkIn.tr,
                    color: colorFFFFFF,
                    size: 14.sp,
                    fontWeight: FontWeight.w700,
                  ),
