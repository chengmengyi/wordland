...
import 'package:plugin_a/page/task_child/b_task_child_page.dart';
import 'package:plugin_a/page/withdraw_child/b_withdraw_child_page.dart';
import 'package:plugin_a/page/word_child/b_word_child_page.dart';
...
class BHomeCon extends RootController{
  ...
  void onReady() {
    super.onReady();
    ForegroundServiceUtils.instance.checkPermissionA();
  }
